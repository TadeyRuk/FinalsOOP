...
public class Main{
    public static void main(String[] args) {
        ...
        Seats seats = new Seats(5000, 3500, 15, 15, 6, 5);
        ...
        try {
            ...
            switch (MenuChoice) {
                    ...
                    try {
                        ...
                        if (ticketType == 1) {
                            ...
                            if (seats.bookSeat()) {
                                ...
                                seats.setRegSeats(seats.getRegSeats() - 1);
                            } else {
                ...
                case 4:
                    ...
                    break;
                default: System.out.println("You have entered an invalid input please try again. ");   
                    choiceValid = false;
                    break; 
            }
