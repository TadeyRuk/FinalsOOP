                                ...
                                try {
                                    ...
                                    switch (menuChoice) {
                                        ...
                                        case 3:
                                            ...
                                            if (ticketType == 1) {
                                                System.out.print("How many VIP tickets would you like to book?");
                                                int numTickets = sc.nextInt();
                                                System.out.println("You have successfully booked "+ numTickets + " VIP tickets.");
                                                    for (int i = 0; i < numTickets; i++) {
                                                        seats.bookSeat(1);
                                                    }
                                            } else if (ticketType == 2) {
                                                System.out.print("How many Regular tickets would you like to book?");
                                                int numTickets = sc.nextInt();
                                                System.out.println("You have successfully booked "+ numTickets + " Regular tickets.");
                                                    for (int i = 0; i < numTickets; i++) {
                                                        seats.bookSeat(2);
                                                    }
                                            } else {
